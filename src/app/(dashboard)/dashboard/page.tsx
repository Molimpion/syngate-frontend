...
// Variantes de animação para efeito em cascata (stagger)
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Grid pattern sutil para textura tecnológica */}
        <div
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between p-6 md:p-8 text-white gap-6">
          ...
          <div className="flex items-start md:items-center gap-5">
            {/* Ícone com Box Shadow e fundo Glassmorphism */}
            ...
            <div>
              <div className="flex items-center gap-2.5 mb-1.5">
                {/* Ponto verde pulsante de "Online" */}
              ...
              <p className="text-blue-100/70 text-sm md:text-base font-medium max-w-lg leading-relaxed">
                Monitoramento em tempo real operando com <span className="text-white">latência mínima</span> nos pontos de acesso.
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between px-1">
             <h3 className="text-lg font-bold text-slate-800 tracking-tight">Fluxo de Acessos</h3>
        ...
        <div className="space-y-6">
           <motion.div variants={itemVariants} className="p-6 bg-white rounded-xl border border-slate-200/60 shadow-sm hover:shadow-md transition-shadow">
             <div className="flex items-center gap-3 mb-4 text-[#004a99]">
               <ShieldCheck className="h-6 w-6" />
               <h3 className="font-bold tracking-tight">Auditoria</h3>
             </div>
             <p className="text-sm text-slate-500 mb-6 leading-relaxed">Acompanhe a integridade dos acessos e realize varreduras nos logs do sistema.</p>
           ...
           <motion.div variants={itemVariants} className="p-6 bg-white rounded-xl border border-slate-200/60 shadow-sm">
             <div className="flex items-center gap-3 mb-5 text-[#004a99]">
               <Cpu className="h-6 w-6" />
               <h3 className="font-bold tracking-tight">Infraestrutura</h3>
             </div>
